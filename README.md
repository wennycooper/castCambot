# castCambot sender and receiver app

This demo application shows how to send messages from an Android device to a receiver using a custom namespace and show video on Chromecast. 
